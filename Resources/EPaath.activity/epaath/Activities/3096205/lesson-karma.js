...
function lesson_karma() {
    return Karma({image: [{name:'help', file:'help.png'},
                          {name:'boy', file:'0.png'},
                          {name:'monkey', file:'1.png'},
                          {name:'duck', file:'2.png'},
                          {name:'teacher', file:'3.png'},
                          {name:'man', file:'4.png'},
                          {name:'dog', file:'5.png'},
                          {name:'mother', file:'6.png'},
                          {name:'father', file:'7.png'},
                          {name:'baby', file:'8.png'},
                          {name:'driver', file:'9.png'},
                          {name:'a', file:'a.png'},
                          {name:'b', file:'b.png'},
                          {name:'c', file:'c.png'},
                          {name:'d', file:'d.png'},
